...
import ReactNative, { StyleSheet, View, Dimensions, TouchableWithoutFeedback, Animated } from 'react-native';

// var React = require('react-native');
// var {  AppRegistry,  StyleSheet,  View,  Dimensions,  TouchableWithoutFeedback,  Animated} = React;
// var Art = require('ReactNativeART');
var Art = ReactNative.ART;
...
var HEART_COLOR = 'rgb(226,38,77)';
var GRAY_HEART_COLOR =  "rgb(204,204,204)";
var FILL_COLORS = [  'rgba(221,70,136,1)',  'rgba(212,106,191,1)',  'rgba(204,142,245,1)',  'rgba(204,142,245,1)',  'rgba(204,142,245,1)',  'rgba(0,0,0,0)'];
var PARTICLE_COLORS = [  'rgb(158, 202, 250)',  'rgb(161, 235, 206)',  'rgb(208, 148, 246)',  'rgb(244, 141, 166)',  'rgb(234, 171, 104)',  'rgb(170, 163, 186)']
...
var ExploadingHearts = React.createClass({
    getInitialState: function() {
         return {      animation: new Animated.Value(0)     };
     },
     explode: function() {
...
module.exports = ExploadingHearts;
// AppRegistry.registerComponent('SampleApp', () => ExploadingHearts);","index.android.js":"'use strict';var React = require('react-native');
